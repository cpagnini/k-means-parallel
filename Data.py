...
def main():
    ...
    for p in [100, 1000, 10000, 100000]:
        generate_dataset(points=p, n_features=2, centers=5, std=0.3, file_name=f'data_{p}.csv', centroids_file_name=f'2D_data_3_centroids.csv', output_directory=DATASETS_DIR)
